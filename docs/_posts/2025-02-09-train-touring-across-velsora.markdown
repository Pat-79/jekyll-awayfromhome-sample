...
- Ride the cliffline segment from Rhen to Oltan.
- Stop in Midcourt for a one-day old-town walking loop.
- Visit platform markets in East Vale stations.
- Take a late train to see sunset over the Glassea marshes.

## Do and don't for this rail tour

- Do reserve window seats for scenic legs.
- Do keep offline copies of your timetable.
- Do label luggage clearly for quick transfers.
- Don't overpack for frequent platform changes.
- Don't assume dining cars operate on short routes.
- Don't miss the local rail museum stops.

## Activity I did: station-to-station photo challenge
